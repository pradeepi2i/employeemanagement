...
public class ProjectController {
    ...
    public ModelAndView addProject(@ModelAttribute("project") ProjectDTO projectDTO) {
        ...
        return modelAndView.addObject("project", new ProjectDTO());
    }
     ...
     *
     */
    @GetMapping("/project/assign/{id}/{employeeId}")
     ...
     *
     */
    @GetMapping("/project/searchProject/{id}")
     ...
     */
    @GetMapping("/project/modifyProject/{id}")
