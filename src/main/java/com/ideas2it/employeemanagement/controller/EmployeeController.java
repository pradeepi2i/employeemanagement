...
public class EmployeeController {
    ...
    private ModelAndView modelAndView = new ModelAndView("employee.jsp");
    ...
    @GetMapping("/create")
    public ModelAndView addEmployee(@ModelAttribute("employee") EmployeeDTO employeeDTO) {
    ...
    private ModelAndView updateDispatch(@PathVariable("id") int id) {
        ...
        return modelAndView.addObject("Employee not found");
    }
    ...
    public ModelAndView createEmployee(@ModelAttribute("employee") EmployeeDTO employeeDTO) {
        ...
        return modelAndView.addObject("message", "Employee Created");
    }
